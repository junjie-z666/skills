...
2. 检查是否配置了mcp服务器，未配置使用`mcp add maestro -- maestro mcp` 添加mcp
3. 使用maestro mcp 打开 maestro viewer （open_maestro_viewer）
4. 查看是否打开正常，打开成功显示对应的网页链接。打开异常，则检查maestro cli 和mcp 是否安装成功
5. 如果 CLI 未安装：
